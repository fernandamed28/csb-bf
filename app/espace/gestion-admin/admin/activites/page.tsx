        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div className="flex gap-2 items-center">
              ...
              <button
                className="bg-blue-600 text-white px-4 py-2 rounded-md flex items-center gap-2 hover:bg-blue-700 transition shadow"
                onClick={() => {
                  setEditing(null);
                  setModalOpen(true);
                }}
              >
                <PlusIcon className="w-5 h-5" /> Nouvelle activité
              </button>
            </div>
          </div>
              ...
              filtered.map((act) => {
                ...
                return (
                  <motion.div
                    ...
                    onClick={() =>
                      router.push(
                        `/espace/gestion-admin/admin/activites/${act.id}?from=${encodeURIComponent(pathname)}`
                      )
                    }
                  >
                    ...
                    <div className="mt-4 flex justify-between items-center text-xs text-gray-500">
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          router.push(
                            `/espace/gestion-admin/admin/activites/${act.id}?from=${encodeURIComponent(act.titre)}`
                          );
                        }}
                      >
                        Détails
