...
function isActiveNav(pathname: string, href: string) {
  // Pour "Gestion des activités", actif aussi sur les sous-pages /activites/*
        ...
        <>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-18 items-center justify-between">
              ...
              <div className="hidden md:flex items-center space-x-3">
                <span className="text-gray-700 font-semibold">Admin CSB</span>
          ...
          <DisclosurePanel className="md:hidden bg-white border-t border-blue-100 shadow-md">
            <div className="space-y-1 px-4 py-3">
              ...
              <Link
                href="/"
                className="block text-red-600 hover:bg-red-50 rounded-md px-3 py-2 text-base font-semibold"
              >
                Déconnexion
              </Link>
            </div>
