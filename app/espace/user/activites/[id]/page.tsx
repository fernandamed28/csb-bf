          ...
          <div className="max-w-full md:max-w-7xl mx-auto bg-white p-4 md:p-8 rounded-2xl shadow space-y-6 overflow-x-auto">
            <div className="flex flex-col md:flex-row gap-4 md:justify-between items-center mb-6">
              <button
                ...
                onClick={() => router.push("/espace/user/activites")}
              >
              ...
              <div>
                ...
                {activite.commentaire && (
                  <p className="text-gray-400 text-sm  mt-2 text-justify">
                    Commentaire : <br /> {activite.commentaire}
                  </p>
                )}
              </div>
            </div>
                ...
                <tbody>
                  {lignes.length === 0 ? (
                    ...
                    lignes.map((l: any, idx: number) => (
                      <tr key={idx} className="hover:bg-blue-50 transition-colors text-gray-600 text-sm align-top">
